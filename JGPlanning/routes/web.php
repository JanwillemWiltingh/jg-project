...
Route::name('rooster.')->prefix('rooster/')->group(function (){
    ...
    Route::get('/disable_days/{week}/{year}/{day}/{user}', [RoosterController::class, 'disable_days_click'])->name('disable_days_click');
...
//admin rooster table
    Route::name('rooster.')->prefix('rooster/')->middleware('ensure.admin')->group(function (){
        ...
        Route::get('/un_solidify/{user}', [RoosterAdminController::class, 'un_plan_user_next_week'])->name('un_plan_next_week');
    });
