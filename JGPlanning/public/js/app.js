...
__webpack_require__(/*! ./components/navbar-script */ "./resources/js/components/navbar-script.js");

__webpack_require__(/*! ./jquery.min */ "./resources/js/jquery.min.js");

__webpack_require__(/*! ./bootstrap-material-design.min */ "./resources/js/bootstrap-material-design.min.js");

__webpack_require__(/*! ./popper.min */ "./resources/js/popper.min.js");

/***/ }),

/***/ "./resources/js/bootstrap-material-design.min.js":
/*!*******************************************************!*\
  !*** ./resources/js/bootstrap-material-design.min.js ***!
  \*******************************************************/
...
/***/ "./resources/js/components/navbar-script.js":
/*!**************************************************!*\
  !*** ./resources/js/components/navbar-script.js ***!
  \**************************************************/
/***/ (() => {
  ...
  $().ready(function () {
    ...
    $('.fixed-plugin .img-holder').click(function () {
      ...
      if ($('.switch-sidebar-image input:checked').length === 0) {
        var _new_image = $('.fixed-plugin li.active .img-holder').find("img").attr('src');

        var _new_image_full_page = $('.fixed-plugin li.active .img-holder').find('img').data('src');

        $sidebar_img_container.css('background-image', 'url("' + _new_image + '")');
        $full_page_background.css('background-image', 'url("' + _new_image_full_page + '")');
      }
...
/***/ "./resources/js/components/userview.js":
/*!*********************************************!*\
  !*** ./resources/js/components/userview.js ***!
  \*********************************************/
/***/ (() => {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\Laravel Project\\JGPlanning\\node_modules\\jquery\\dist\\jquery.js'");
