    ...
    <div class="crud-user-form fadeInDown" style="left: 20%; width: 60%">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button class="btn btn-primary jg-color-3 border-0" value="Ga Terug"><a href="{{route('user.clock.index')}}" style="text-decoration: none; color: white;">Ga Terug</a></button>
            </div>
        </div>
    </div>
@endsection
