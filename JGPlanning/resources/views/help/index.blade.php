...
{{--  If you want to add a new accordion be sure to change the id,data,aria from the accordion so the right accordion will open at all times and won't open 2 at the same time :)  --}}
    <!--suppress ALL -->
<h1>Hier vind je alle uitleg over JG Rooster</h1>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseAdminOne" class="accordion-collapse collapse show" aria-labelledby="headingAdminOne" data-bs-parent="#helpAdminAccordion">
                    <div class="accordion-body">
                        ...
                        @endif
                        Klik daarna op de grote knop <strong>Toevoegen</strong> onderaan.<br>
    ...
    <div class="accordion" id="helpAccordion">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#helpAccordion">
                <div class="accordion-body">
                    Zodra je bent ingelogd en je wilt inklokken, klik dan op de knop <strong>'Inklokken'</strong> op het dashboard. Indien nodig geef een aantekening mee.
                </div>
            </div>
        </div>
        {{-- Accordion item title --}}
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#helpAccordion">
                <div class="accordion-body">
                    Zodra je bent ingeklokt en je werktijd zit erop, klik dan op de knop <strong>'Uitklokken'</strong>. Hier kan je niet een aantekening aan meegeven. Kloktijden worden doorgestuurd naar de Administrators.
                </div>
            </div>
        </div>
        {{-- Accordion item title --}}
